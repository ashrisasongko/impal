	...
	<div class="container">
		<h1 align="right">Citramart <br> Telkom University</h1>
			...
			<div class="row">
				...
				<div class=col-md-5>
				<form method="post" action="tambahstock.php">
				<h1>Stock Opname</h1><br>
				<div class="form-group">
				  ...
				  <div class="form-group">
				    <label for="exampleInputPassword1">Jumlah Stock Baru</label>
				    <input type="text" class="form-control" name="JumlahStock" placeholder="Jumlah Stock Baru">
				  </div>			  
